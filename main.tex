...
%Therefore, we have yet to properly assess the effectiveness of the algebraic approach in the study of non-regular language classes. Perhaps, like it did for the regular languages, algebraic characterizations will prove to be a powerful tool for the study of the non-regular language classes---classes for which the standard approaches have also hitherto come up short. Regardless, though, the first step on this journey is to construct algebraic characterizations of more non-regular language classes.
