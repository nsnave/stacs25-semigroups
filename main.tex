...
in which the variables among $x_i$ occurring in the subformula $\phi_i$ are bound.  The semantics of this quantifier are given by the rule that 
...
We also write $\Gamma_{d,\gamma}^{S,B}$ for the vectorization of this quantifier of dimension $d$.
\end{definition}
